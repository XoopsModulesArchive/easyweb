...
function html_editor($textareaname)
{
    if (preg_match('/(MSIE)/i', $_SERVER['HTTP_USER_AGENT'])) {
        ...
        ipsCodeTarea($textareaname);

        ipsSmilies($textareaname);
    }
}

function init_editor($textareaname)
{
    global $xoopsDB, $$textareaname, $conttex;

    $myts = new MyTextSanitizer();

    $$textareaname = (string)$conttex;

    $$textareaname = $myts->displayTarea($$textareaname, '1', '1', '1');
    ...
    <script type="text/javascript">
        ...
        function Help_OnClick() {
            window.open("<?=XOOPS_URL?>/modules/easyweb/images/wysiwyg/help_document.htm", "wHelp", "toolbar=0, scrollbars=yes, width=400, height=450");
        }
        ...
        function copyValue_<?php echo $textareaname; ?>() {
            ...
            document.all
        .<?php echo $textareaname; ?>.
            value = theHtml;
        }

        function SwapView<?php echo $textareaname; ?>_OnClick() {
            if (document.all.btnSwapView<?php echo $textareaname; ?>.value == "<?php echo _MD_VIEWHTML; ?>") {
                var sMes = "<?php echo _MD_VIEWWAYSIWIG; ?>";
                var sStatusBarMes = "Current View Html";
            } else {
                var sMes = "<?php echo _MD_VIEWHTML; ?>"
        ...
        function makeUrl<?php echo $textareaname; ?>() {
            sUrl = document.all.what<?php echo $textareaname; ?>.value + document.all.url<?php echo $textareaname; ?>.value;
    ...
    <textarea name="<?php echo $textareaname; ?>" style="display: none;"><?php echo $$textareaname; ?></textarea>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <table border="0">
                                                            <tr valign="baseline">
                                                                <td nowrap="nowrap">
                                                                    <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/new.gif" width="16" height="16" border="0" alt="<?php echo _MD_NEWFILE; ?>" onClick="newFile();">&nbsp
                                                                    <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/Cut.gif" width="16" height="16" border="0" alt="<?php echo _MD_CUT; ?>" onClick="doFormat('Cut')">&nbsp
                                                                    <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/Copy.gif" width="16" height="16" border="0" alt="<?php echo _MD_COPY; ?>" onClick="doFormat('Copy')">&nbsp
                                                                    <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/Paste.gif" border="0" alt="<?php echo _MD_PASTE; ?>" onClick="doFormat('Paste')" width="16" height="16">&nbsp
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td valign="top">
                                                        <table border="0">
                                                            <tr valign="baseline">
                                                                <td nowrap="nowrap">
                                                                    <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/para_bul.gif" width="16" height="16" border="0" alt="<?php echo _MD_BULLETLIST; ?>" onClick="doFormat('InsertUnorderedList');">&nbsp
                                                                    <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/para_num.gif" width="16" height="16" border="0" alt="<?php echo _MD_NUMBREDLIST; ?>" onClick="doFormat('InsertOrderedList');">&nbsp
                                                                    <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/indent.gif" width="20" height="16" alt="<?php echo _MD_INDENT; ?>" onClick="doFormat('Indent')">&nbsp
                                                                    <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/outdent.gif" width="20" height="16" alt="<?php echo _MD_OUTDENT; ?>" onClick="doFormat('Outdent')">&nbsp
                                                                    <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/hr.gif" width="16" height="18" alt="<?php echo _MD_HR; ?>" onClick="doFormat('InsertHorizontalRule')">&nbsp
                                                                    <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/picture.gif" width="16" height="18" alt="<?php echo _MD_IMAGE; ?>"
                                                                         onClick="var strURL = window.prompt('Enter URL s Picture', '');if (strURL!=null) {doFormat('InsertImage',strURL);}">&nbsp
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td valign="top">
                                                        <table border="0">
                                                            <tr valign="baseline">
                                                                <td nowrap="nowrap">
                                                                    <img src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/link.gif" border="0" alt="<?php echo _MD_EXURL; ?>"></td>
                                                                <td nowrap="nowrap">
                                                                    <select id="what<?php echo $textareaname; ?>" style="font: 8pt verdana;">
                                                                ...
                                                                <td>
                                                                    <input class="input" type="text" id="url<?php echo $textareaname; ?>" size="25" style="font: 8pt verdana;">
                                                                </td>
                                                                <td>
                                                                    <input type="button" id="buttonadd<?php echo $textareaname; ?>" value="<?php echo _MD_ADD; ?>" onClick="makeUrl<?php echo $textareaname; ?>();" style="font: 8pt verdana;">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td>
                                                        <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/help.gif" width="20" height="20" align="middle" alt="<?php echo _MD_HELP; ?>" onClick="Help_OnClick();">
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                            ...
                                            <table border="0">
                                                <tr>
                                                    <td nowrap="nowrap" valign="baseline">
                                                        <div align="left">
                                                            <select id="font<?php echo $textareaname; ?>"
                                                                    onChange="if (document.all.font<?php echo $textareaname; ?>.value !=1) {doFormat('FontName',document.all.font<?php echo $textareaname; ?>.value);document.all.font<?php echo $textareaname; ?>.selectedIndex = 0;}"
                                                                    style="font: 8pt verdana;">
                                                                <option value="" selected="selected"><?php echo _MD_SELECTFONT; ?></option>
                                                            ...
                                                            <select id="size<?php echo $textareaname; ?>"
                                                                    onChange="if (document.all.font<?php echo $textareaname; ?>.value !='None') {doFormat('FontSize',document.all.size<?php echo $textareaname; ?>.value);document.all.size<?php echo $textareaname; ?>.selectedIndex = 0;}"
                                                                    style="font: 8pt verdana;">
                                                                <option value="None" selected="selected"><?php echo _MD_SIZE; ?></option>
                                                            ...
                                                            <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/Bold.gif" width="16" height="16" border="0" align="absmiddle" alt="<?php echo _MD_BOLD; ?>" onClick="doFormat('Bold')">&nbsp
                                                            <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/Italics.gif" width="16" height="16" border="0" align="absmiddle" alt="<?php echo _MD_ITALIC; ?>" onClick="doFormat('Italic')">&nbsp
                                                            <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/underline.gif" width="16" height="16" border="0" align="absmiddle" alt="<?php echo _MD_UNDERLINE; ?>" onClick="doFormat('Underline')">&nbsp
                                                            <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/left.gif" width="16" height="16" border="0" alt="<?php echo _MD_ALIGNLEFT; ?>" align="absmiddle" onClick="doFormat('JustifyLeft')">
                                                            <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/centre.gif" width="16" height="16" border="0" alt="<?php echo _MD_ALIGNCENTER; ?>" align="absmiddle" onClick="doFormat('JustifyCenter')">&nbsp
                                                            <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/right.gif" width="16" height="16" border="0" alt="<?php echo _MD_ALIGNRIGHT; ?>" align="absmiddle" onClick="doFormat('JustifyRight')">&nbsp
                                                        </div>
                                                    </td>
                                                    <td align="left" nowrap="nowrap" valign="baseline">
                                                        <input type="button" id="btnSwapView<?php echo $textareaname; ?>" value="<?php echo _MD_VIEWHTML; ?>" onClick="SwapView<?php echo $textareaname; ?>_OnClick();" style="width:100px; font: 8pt verdana;">
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                    ...
                    <tr valign="top" align="left">
                        <td valign="top">
                            <table border="0">
                                ...
                                <tr>
                                    <td nowrap="nowrap">
                                        <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/frame.gif" border="0" alt="<?php echo _MD_FIELDSET; ?>" onClick="doFormat('InsertFieldset','padding')" width="31" height="31">&nbsp
                                        <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/frameb1.gif" border="0" alt="<?php echo _MD_solid1; ?>" onClick="doFormat('InsertFieldset','paddingb')" width="31" height="31">&nbsp
                                        <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/frameb3.gif" border="0" alt="<?php echo _MD_solid3; ?>" onClick="doFormat('InsertFieldset','paddingbb')" width="31" height="31">&nbsp
                                        <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/framebd.gif" border="0" alt="<?php echo _MD_double; ?>" onClick="doFormat('InsertFieldset','paddingbd')" width="31" height="31">&nbsp
                                        <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/framedt.gif" border="0" alt="<?php echo _MD_dotted; ?>" onClick="doFormat('InsertFieldset','paddingbs')" width="31" height="31">&nbsp
                                        <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/marquee.gif" border="0" alt="<?php echo _MD_MARQUEE; ?>" onClick="doFormat('InsertMarquee')" width="31" height="31">&nbsp
                                        <img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/textbox.gif" border="0" alt="<?php echo _MD_TEXTAREA; ?>" onClick="doFormat('InsertTextArea')" width="31" height="31">&nbsp
                                        <a href='javascript:openWithSelfMain("<?= XOOPS_URL ?>/modules/easyweb/admin/images.php","Online",640,500);'><img style="cursor:hand;" src="<?= XOOPS_URL ?>/modules/easyweb/images/wysiwyg/gallery.gif" border="0" alt="<?php echo _MD_GALLERY; ?>" width="31"
                                                                                                                                                          height="31"></a>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr valign="top">
                                    <td width="100%" height="100%" valign="top">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" height="100%">
                                            <tr valign="top">
                                                <td bgcolor="#FFFFFF">
                                                    <iframe name="<?php echo $myEditor; ?>" id="<?php echo $myEditor; ?>" src="<?= XOOPS_URL ?>/modules/easyweb/include/pdedit.php?textareaname=<?php echo $textareaname; ?>" onfocus="initToolBar(this,'<?php echo $myEditor; ?>');"
                                                            onblur="copyValue_<?php echo $textareaname; ?>();" width="100%" height="700"></iframe>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td width="9%" align="center">
                                        <table bgcolor="#000000" width="74" id="cpick<?php echo $textareaname; ?>" border="1" cellspacing="0" cellpadding="0" align="center">
                                            <tr>
                                                <td>&nbsp;</td>
                                            </tr>
                                        </table>
